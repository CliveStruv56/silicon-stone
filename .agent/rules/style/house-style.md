...
- **Links & Citations**: Substantiate claims by linking to primary sources where possible. Cite retrieved work explicitly (e.g., note the source article when pulling from Pinecone).
- **Formatting**:
