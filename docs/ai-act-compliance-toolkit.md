...
The PDF and its two companion workbooks are the £79 / £149 product attached to the Lemon Squeezy listing — see `LAUNCH.md` §0 for the file-to-product mapping. The £149 Professional tier also needs a 30-minute video walkthrough, which is not yet recorded.
