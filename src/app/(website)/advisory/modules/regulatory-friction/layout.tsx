...
const description =
  'Where US and EU requirements pull against each other across your operations, friction-scored, with a priority matrix and a transatlantic roadmap. The follow-on module to the free Policy Stress-Test.'
