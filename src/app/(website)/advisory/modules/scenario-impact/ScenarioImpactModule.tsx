...
export function ScenarioImpactModule({ coverage }: Props) {
  return (
    <ModulePage
      ...
      body={<>
        <p>This project builds scenarios around the events that could affect your business and puts a number against each one, by business unit, so that the argument in the room turns on how much is at risk and where, rather than on whether a risk exists.</p>
