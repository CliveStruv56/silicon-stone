  ...
  return (
    <FocusedEngagementPage
      hero={{
        ...
        imageAlt: 'Two chairs at a table with a notebook, an analytical chart and coffee cups, ready for a focused discussion',
        imageCaption: 'Space to work through the question that matters.',
      }}
      audience={<>
