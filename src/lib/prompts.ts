...
**The Pitch:** a low-pressure pitch to siliconandstone.com — direct ${persona.role} to a free interactive tool (Compliance Checker, Supply Chain Mapper), and mention the consolidated AI Act Compliance Toolkit, from ${gbp(AMOUNTS.toolkitStandard)}, which includes the gap assessment, vendor scorecard, register and action plan.
