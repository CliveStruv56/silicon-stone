...
export const POLICIES: Policy[] = [
  {
    ...
    shortName: 'AI Act',
    jurisdiction: 'EU',
    effectiveDate: 'Phased application; transparency rules in force since 2 Aug 2026. Under the Digital Omnibus, standalone (Annex III) high-risk obligations move to 2 Dec 2027 and product-integrated (Annex I) to 2 Aug 2028.',
    status: 'Phasing In',
    ...
    industryImpacts: {
      'AI/ML': {
        ...
        keyDeadlines: [
          '2 Feb 2025: prohibited practices and AI literacy obligations — in force',
          '2 Aug 2025: governance rules and GPAI obligations — in force',
