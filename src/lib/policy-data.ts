...
export const POLICIES: Policy[] = [
  {
    ...
    shortName: 'AI Act',
    jurisdiction: 'EU',
    effectiveDate: 'August 2, 2026 (full requirements)',
    status: 'Phasing In',
  ...
  },
  {
    ...
    status: 'Active',
    description: 'Export restrictions on advanced semiconductors, manufacturing equipment, and related technology to China and other countries of concern.',
    ...
    industryImpacts: {
      ...
      'AI/ML': {
        ...
        requirements: [
          ...
          'Cloud computing service controls',
