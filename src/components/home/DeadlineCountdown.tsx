  ...
  return (
    <div className="w-full bg-stone-charcoal border-none px-6 py-3">
      <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between md:gap-6">
        <div>
          <div className="font-mono text-xs font-bold uppercase tracking-wider text-silicon-amber">
        ...
        <Link
          ...
          className="inline-flex shrink-0 items-center gap-1.5 text-xs font-medium text-stone-teal transition-colors hover:text-silicon-amber"
        >
          Assess readiness
