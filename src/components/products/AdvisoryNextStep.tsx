    ...
    <section className="border-t border-silicon-amber/30 bg-silicon-amber/5">
      <div className="mx-auto max-w-7xl px-6 py-10 lg:px-8 lg:py-12">
        <div className="mx-auto max-w-2xl text-center">
          <div className="mb-3 font-mono text-xs uppercase tracking-wider text-silicon-amber">
            Take it further
          </div>
          ...
          <div className="flex flex-col justify-center gap-4 sm:flex-row">
            <Link href="/advisory#contact">
              <span className="inline-flex items-center gap-1.5 rounded-md bg-silicon-amber px-5 py-2.5 text-sm font-semibold text-ink-on-accent transition-colors hover:bg-silicon-amber/90">
                Book an Advisory Briefing — £450
                <ArrowRight className="h-4 w-4" />
              </span>
            </Link>
            <Link href="/advisory#retainer">
              <span className="inline-flex items-center gap-1.5 rounded-md border border-silicon-amber/60 px-5 py-2.5 text-sm font-medium text-silicon-amber transition-colors hover:bg-silicon-amber/10">
