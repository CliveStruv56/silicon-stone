...
const eslintConfig = [
  {
    ignores: [
      ...
      "generated-docs/**",
      "outputs/**",
      // Scratch puppeteer scripts + product build scripts: not app source, and
      // their lint errors were drowning out real ones in `npm run check`.
      "design-review/**",
      "deliverables/**",
      // Generated by serwist at build time from src/app/sw.ts:
      "public/sw.js",
      "public/swe-worker*",
    ],
  },
